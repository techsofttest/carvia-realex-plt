...
export function ContactFormSection() {
  ...
  const productParam = searchParams ? searchParams.get("product") || "" : "";
...
const baseUrl = process.env.NEXT_PUBLIC_API_URL;
  ...
  return (
    <section id="contact" className="relative w-full py-20 lg:py-28 bg-[#011842] text-white overflow-hidden">
        ...
        <div className="max-w-3xl lg:w-7/12">
          {submitted ? (
            <div className="py-12 space-y-6 text-left">
              ...
              <h3 className="text-3xl font-bold text-white">Inquiry Submitted Successfully!</h3>
              <p className="text-sm text-gray-200 max-w-md leading-relaxed">
                Thank you for contacting our trade desk. We have received your request and will reach out to you within 24 hours.
              </p>
              <Button
                onClick={() => {
                  setSubmitted(false);
                  setFormData({ name: "", email: "", phone: "", company: "", country: "", product: "", message: "", captchaInput: "" });
                  generateCaptcha();
                }}
                variant="primary"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <p className="text-sm text-gray-200">Fill out the details below to receive product specifications and pricing.</p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  onChange={(e) => {
                    // Allows only numbers, plus, spaces, parentheses, and dashes
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-4">
                  <div className="bg-white/10 border border-white/30 px-6 py-3 tracking-widest font-mono text-lg font-bold text-yellow-300 select-none">
                    {captchaCode}
                  </div>
                  <button
                    type="button"
              ...
              <Button type="submit" variant="primary" className="w-full h-12 text-sm uppercase tracking-wider font-bold">
