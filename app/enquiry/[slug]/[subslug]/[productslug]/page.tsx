...
async function getProduct(slug: string,subslug:string, productslug: string): Promise<ProductResponse> {
  ...
  const res = await fetch(`${baseUrl}/product/${slug}/${subslug}/${productslug}`, {
    next: {
      revalidate: 60,
    },
  });
